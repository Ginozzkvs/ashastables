...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .page-header-subtext { color: #9ca3af; font-size: 0.875rem; }
    ...
    .form-input:focus { outline: none; background: rgba(212, 175, 55, 0.1); border-color: #e6c547; }
    
    .btn { padding: 0.75rem 1.5rem; background: #d4af37; color: #0f1419; border: none; font-weight: 600; cursor: pointer; text-transform: uppercase; font-size: 0.875rem; transition: all 0.3s; }
    ...
    .export-btn { display: inline-block; padding: 0.75rem 1.5rem; border: 1px solid #d4af37; color: #d4af37; text-decoration: none; font-weight: 600; text-transform: uppercase; font-size: 0.875rem; transition: all 0.3s; margin-bottom: 2rem; }
    .export-btn:hover { background: rgba(212, 175, 55, 0.1); }
</style>
...
<div class="container">
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <p class="page-header-subtext">Financial analytics and membership revenue breakdown</p>
        </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value" style="font-size: 1.25rem;">{{ $startDate->format('M d') }} - {{ $endDate->format('M d, Y') }}</div>
            </div>
        </div>

        <!-- Revenue by Membership -->
        <h3 style="color: #d4af37; font-size: 1.5rem; margin: 2rem 0 1.5rem 0; font-family: 'Cormorant Garamond', serif;">Revenue by Membership Type</h3>
        <div class="table-wrapper">
            <table>
                ...
                <tbody>
                    @foreach($revenueByMembership as $item)
                    <tr>
                        <td><strong>{{ $item['membership_name'] }}</strong></td>
        ...
        <!-- Daily Revenue -->
        <h3 style="color: #d4af37; font-size: 1.5rem; margin: 2rem 0 1.5rem 0; font-family: 'Cormorant Garamond', serif;">Daily Revenue Trend</h3>
        <div class="table-wrapper">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="3" style="text-align: center; color: #9ca3af; padding: 2rem;">No data for selected period</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
